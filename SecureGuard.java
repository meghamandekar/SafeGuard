...
public class SecureGuard implements ActionListener {
    ...
    SecureGuard() {
        frame = new JFrame("SecureGuard");
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Password-Manager\\img\\icon.png"));
